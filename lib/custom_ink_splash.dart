...
class InkSplashFactory extends InteractiveInkFeatureFactory {
  final Duration unconfirmedSplashDuration;
  final Duration splashFadeDuration;

  const InkSplashFactory({
    this.splashFadeDuration = const Duration(milliseconds: 200),
    this.unconfirmedSplashDuration = const Duration(seconds: 1),
  });
...
class InkSplash extends InteractiveInkFeature {
  ...
  InkSplash({
    ...
    _radiusController = AnimationController(
        duration: unconfirmedSplashDuration, vsync: controller.vsync)
